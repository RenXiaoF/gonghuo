...
Page({
  ...
  bindViewTap: function () {
    ...
    if (store_info) {
      ...
      wx.redirectTo({
        url:
          "/pages/order_receive_management/order_receive_management?store_id=" +
          store_id +
          "&providerid=" +
          provider_id +
          "&server_ip=" +
  ...
  bindViewTap1: function () {
    ...
    if (store_info) {
      ...
      wx.redirectTo({
        url:
          "/pages/shipping_management/shipping_management?store_id=" +
          store_id +
          "&providerid=" +
          provider_id +
          "&server_ip=" +
  ...
  bindGoBack: function () {
    wx.navigateTo({
      url: "/pages/order_receive_management/order_receive_management",
    });
  },
  /** 返回订单管理 */
  bindGoBack1: function () {
    wx.navigateTo({
      url: "/pages/shipping_management/shipping_management",
    });
  },
  /** 返回 我的送料 */
